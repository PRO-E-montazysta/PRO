...
public class Specialist extends Employee {
    ...
    public Specialist(Long id, String firstName, String lastName, String email, String password, String username,
                      ...
                      List<Attachment> attachments, List<ToolEvent> toolEvents, List<Orders> orders, List<DemandAdHoc> demandAdHocs) {
