...
public class ElementInWarehouseController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('SCOPE_SPECIALIST', 'SCOPE_WAREHOUSE_MAN', 'SCOPE_WAREHOUSE_MANAGER')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('SCOPE_WAREHOUSE_MANAGER')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('SCOPE_WAREHOUSE_MAN', 'SCOPE_WAREHOUSE_MANAGER')")
