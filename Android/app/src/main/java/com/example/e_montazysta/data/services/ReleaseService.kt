...
interface ReleaseService {
    ...
    suspend fun createToolsRelease(
        @Header("Authorization") token: String,
        @Path("id") stageId: Int,
    ...
    suspend fun createElementsRelease(
        @Header("Authorization") token: String,
        @Path("id") stageId: Int,
    ...
    suspend fun createElementsReturn(
        @Header("Authorization") token: String,
        @Path("id") stageId: Int,
        @Path("warehouseId") warehouseId: Int,
