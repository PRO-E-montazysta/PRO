...
class ElementInWarehousesListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentElementInWarehousesBinding =
            FragmentElementInWarehousesBinding.inflate(inflater, container, false)
        ...
        val adapter = ElementInWarehouseListAdapter(CustomClickListener { element ->
            findNavController().navigate(
                ElementInWarehousesListFragmentDirections.actionElementInWarehousesListFragmentToElementInWarehouseDetailFragment(
                    element.id,
                    element.element
                )
            )
        ...
        elementInWarehousesListViewModel.isLoadingLiveData.observe(
            viewLifecycleOwner,
            Observer<Boolean> {
                it?.let {
                    if (it) {
        ...
        // Wyświetlanie błędów
        elementInWarehousesListViewModel.messageLiveData.observe(viewLifecycleOwner) { errorMessage ->
