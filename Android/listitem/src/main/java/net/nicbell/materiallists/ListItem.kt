...
class ListItem @JvmOverloads constructor(
    ...
    fun setSizeType(sizeType: ListItemSizeType) {
        ...
        when (sizeType) {
            ...
            ListItemSizeType.NoLimit -> {
                supportText.isVisible = true
                minHeight = resources.getDimensionPixelSize(R.dimen.list_item_min_height_no_limit)
    ...
    private fun verticallyAlign(params: ConstraintLayout.LayoutParams) {
        params.verticalBias = when (sizeType) {
            ...
            ListItemSizeType.NoLimit -> TOP_VERTICAL_BIAS
        }
    }
    ...
    enum class ListItemSizeType {
        OneLine, TwoLine, ThreeLine, NoLimit
    }
