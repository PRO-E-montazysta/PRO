...
///orderDetails Tables - tu mozna by zrobic generycznie Typy narzedzi i elementy do wyboru

// type OrderStageDetailsTableType = {
//     itemsArray: Array<any> | undefined
//     plannedData: Array<{ numberOfTools: number; toolTypeId: string }> | Array<{ numberOfElements: number; elementId: string }>
